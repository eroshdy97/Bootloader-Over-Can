...
//
////done
//#define BOOTLOADER_ADDRESS_BANK_1              0x00010000
//#define BOOTLOADER_ADDRESS_BANK_2              0x00020000
//#define BOOTLOADER_ADDRESS_FLAG                0x00030000
////done
...
//volatile uint32_t gu32FlashToBank = 0;
//volatile uint32_t gu32DataReceivedLength = 0;
...
//uint32_t gu32DataReceived[5000];
//
//// bootloader
//void RX(void)
//{
...
//
//    uint32_t data32bit;
//    uint32_t programToRun = PROGRAM_TO_RUN_R;
//
...
//    canMsgData.ui32MsgID = BOOTLOADER_CAN_MSG_ID_DATA;
...
//
//    canMsgEnd.ui32MsgID = BOOTLOADER_CAN_MSG_ID_END;
...
//
//    canMsgStart.ui32MsgID = BOOTLOADER_CAN_MSG_ID_START;
...
//
//    canMsgReset.ui32MsgID = BOOTLOADER_CAN_MSG_ID_RESET;
...
//    {
//        CANMessageGet(CAN0_BASE, 3, &canMsgStart, 0);
//        VTABLE_OFFSET_R |= BOOTLOADER_ADDRESS_BANK_2;
//
...
//    {
//        canMsgStart.pui8MsgData = (uint8_t *)&gu32FlashToBank;
//        //poll start
//        while(!dataStart);
//        CANMessageGet(CAN0_BASE, 3, &canMsgStart, 0);
...
//                gu32DataReceived[gu32DataReceivedLength - 1] = data32bit;
//                dataFrameReceived = 0;
//            }
//        }
...
//        gu32DataReceived[55] = &CANIntHandler;
//
...
//                moveApptoRun(gu32DataReceived, BOOTLOADER_ADDRESS_BANK_2, gu32DataReceivedLength * 4);
//                gu32DataReceivedLength = 0;
//
//                programToRun = 2;
//                FlashErase(BOOTLOADER_ADDRESS_FLAG);
//                FlashProgram(&programToRun, BOOTLOADER_ADDRESS_FLAG, sizeof(programToRun));
//
//                VTABLE_OFFSET_R |= BOOTLOADER_ADDRESS_BANK_2;
//
//                __asm(" mov r0, #0x00020000\n");
...
//            case 1:
//            {
//                moveApptoRun(gu32DataReceived, BOOTLOADER_ADDRESS_BANK_1, gu32DataReceivedLength * 4);
//                gu32DataReceivedLength = 0;
//
//                programToRun = 1;
//                FlashErase(BOOTLOADER_ADDRESS_FLAG);
